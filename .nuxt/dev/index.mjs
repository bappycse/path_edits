...
import { provider, isWindows } from 'file:///home/bappy/Workspace/path_edits/node_modules/std-env/dist/index.mjs';
...
const _lazy_OMnE9Q = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_OMnE9Q, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OMnE9Q, lazy: true, middleware: false, method: undefined }
];
