      ...
      <div class="row d_flex">
        ...
        <div class="col-md-6">
          <div class="service_banner_text">
            ...
            <p class="service_price">Starting at <span>0.39$</span> per image</p>
      ...
      <div class="row">
        <div class="col-md-12 details_content">
          ...
          <ul class="advantages_list">
            ...
            <li>The Pix Fax offers a quick yet quality image editing service for all your photo needs. Their experienced editors are able to provide a range of services from basic adjustments such as color, contrast, and brightness, to more complex tasks such as photo retouching and composition.
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/sample/sample1.jpg" alt="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/sample/sample2.jpg" alt="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/sample/sample3.jpg" alt="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/sample/sample4.jpg" alt="">
          </div>
        </div>
      </div>
  ...
  <section class="service_example section_space">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/works/works1.jpg" alt="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/works/works2.jpg" alt="">
          </div>
        </div>
        <div class="col-md-3">
          <div class="sample_box_image">
            <img src="~/assets/images/photo_retouch/works/works3.jpg" alt="">
          </div>
        </div>
      </div>
...
<script setup>
const title = ref(' Pix Fax | Photo Retouching Services');
const description = ref(' Pix Fax provided clipping path related services and Photo Retouching Services');
