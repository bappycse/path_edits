      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <form>
            ...
            <div class="form-group">
              <label for="exampleInputEmail1">WHAT’S YOUR MESSAGE?</label>
...
.contact-box {
  ...
  background: #f2f2f2;
  padding: 50px 0;
  box-shadow: 0 1px 18px -10px #0000004d;
}
.contact-box img {
    margin-bottom: 20px;
}
